  ...
  return (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 64, flexWrap: "wrap", width: "100%" }}>
          <div style={{ flex: "1 1 360px" }}>
            <div className="hero-anim" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(56,189,248,0.1)", border: "1px solid rgba(56,189,248,0.25)", borderRadius: 20, padding: "5px 14px", marginBottom: 28 }}>
            ...
            <h1 className="syne hero-anim-2" style={{ fontSize: "clamp(36px, 6vw, 60px)", fontWeight: 800, lineHeight: 1.1, color: "#f1f5f9", marginBottom: 16 }}>
              Hola, soy<br />
